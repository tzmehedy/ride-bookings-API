...
const generateToken = (payload, secret, expiresIn) => __awaiter(void 0, void 0, void 0, function* () {
    const token = yield jsonwebtoken_1.default.sign(payload, secret, { expiresIn });
    return token;
});
exports.generateToken = generateToken;
const verifyToken = (accessToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedTokenInfo = yield jsonwebtoken_1.default.verify(accessToken, env_1.envVars.JWT_ACCESS_SECRET_KEY);
